function [nodes,elem] = dream2abatet(nodeFile,triFile,featureFile,keepRatio,maxVol,abaMeshFlag)
    % *dream2abatet* 
    ...
    if abaMeshFlag
        ...
        if strcmp(inpFileDir,'') == 0
            inpFileName = [inpFileDir '\dreamTetMesh.inp'];
        else
            inpFileName = 'dreamTetMesh.inp';
        end 
